...
6. Create `seal.mk` file in the `buildroot/package/seal` with the following content:
   ```makefile
   ################################################################################
   #
   # seal
...
13. I have added several FHE demonstrations which are available in the `examples` directory of this repo:
    ...
    Note: Some implementations as of now are not entirely accurate and require further refinement, especially for matrix multiplication, pointwise multiplication, and matrix addition.
...
19. In QEMU, start the Keystone driver:
    ```
    modprobe keystone-driver
    ```

20. Navigate to the examples directory:
    ```
...
## Notes
- Ongoing research and efforts are being made to correct and improve the FHE implementations.
